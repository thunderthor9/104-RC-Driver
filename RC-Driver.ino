...
const uint8_t  channel = 00104; // [TODO]: Replace this blank with your team number

// Pin Definitions
#define in1L 2  // Left L298N, Pin IN1
#define in2L 1  // Left L298N, Pin IN2
#define in3L 5  // Left L298N, Pin IN3
#define in4L 6  // Left L298N, Pin IN4
#define in1R 7  // Right L298N, Pin IN1
#define in2R 8  // Right L298N, Pin IN2
#define in3R 9  // Right L298N, Pin IN3
#define in4R 12  // Right L298N, Pin IN4
#define enL 13   // Left L298N, Pin ENA/B
#define enR 13   // Right L298N, Pin ENA/B    MAY BE WRONG
